...
Further modified by daddycocoaman, just a little.
"""
...
if arguments["make"]:
    ...
    elif option_all and option_path_dir:
        ASSEMBLIES = [
            file[:-4] for file in os.listdir(option_path_dir) if file.endswith(".dll")
        ]
